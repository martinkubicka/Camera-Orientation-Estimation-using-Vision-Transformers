...
from main_first_look_sinenc.model import PoseRegressor
...
model = PoseRegressor("dinov2_vitb14").to(device) # TODO import + model name (niekedy large !!)
# TODO
ckpt_path = "/storage/brno2/home/xkubic45/DP/src/training_45deg/main_first_look_sinenc/model_geo_first_look_45_2nd.pth"
...
plt.tight_layout()
# TODO
plt.savefig(ckpt_path.replace("model_geo_first_look_45_2nd.pth", "") + "orientation_error_first_look.png", dpi=300)
