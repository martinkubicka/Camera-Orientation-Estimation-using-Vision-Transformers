#!/bin/bash
#PBS -N main_first_look_final_big_resnet50_finetune_hdf5_lr1e-5
#PBS -l select=1:ncpus=1:mem=256gb:ngpus=1:gpu_mem=50gb:scratch_local=256gb
#PBS -l walltime=320:00:00
#PBS -q gpu_long

DATADIR=/storage/brno2/home/xkubic45/DP/src/training_45deg/main_first_look_final_big_resnet50_finetune_hdf5_lr1e-5
