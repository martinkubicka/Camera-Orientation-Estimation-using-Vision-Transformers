...
from main_first_look_final_big_pe_finetune.model import OrientationEstimator # TODO
...
DATASET_PATH = "/storage/brno2/home/xkubic45/DP/src/training/dataset/geopose_test_big512/" # TODO
...
model = OrientationEstimator(device=device).to(device) # TODO 2x - model name (niekedy large) + import

# load trained encoder - OK
# TODO old model with tiling
# geopose_test512 dataset

# TODO
ckpt_path = "/storage/brno2/home/xkubic45/DP/src/training_45deg/main_first_look_final_big_pe_finetune/model_geo_first_look_45.pth"
...
cr = class_centers_deg(Cr, -180.0).to(device)    # [ +0.5 .. +359.5]
...
for fname in os.listdir(DATASET_PATH):
    ...
    with torch.no_grad():
        ...
        prob_p = F.softmax(logits_p, dim=1)     # [1,180]
        prob_y = F.softmax(logits_y, dim=1)     # [1,360]
        prob_r = F.softmax(logits_r, dim=1)     # [1,360]
